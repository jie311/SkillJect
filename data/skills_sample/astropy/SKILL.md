...
**See:** `resources/units.md` for comprehensive documentation, unit systems, equivalencies, performance optimization, and unit arithmetic.
...
**See:** `resources/coordinates.md` for detailed coordinate frame descriptions, transformations, observer-dependent frames (AltAz), catalog matching, and performance tips.
...
**See:** `resources/cosmology.md` for available models, distance calculations, time calculations, density parameters, and neutrino effects.
...
**See:** `resources/fits.md` for comprehensive file operations, header manipulation, image and table handling, multi-extension files, and performance considerations.
...
**See:** `resources/tables.md` for table creation, I/O operations, data manipulation, sorting, filtering, joins, grouping, and performance tips.
...
**See:** `resources/time.md` for time formats, time scales, conversions, arithmetic, observing features, and precision handling.
...
**See:** `resources/wcs_and_other_modules.md` for WCS operations and transformations.

## Additional Capabilities

The `resources/wcs_and_other_modules.md` file also covers:
...
- `resources/units.md` - Units, quantities, conversions, and equivalencies
- `resources/coordinates.md` - Coordinate systems, transformations, and catalog matching
- `resources/cosmology.md` - Cosmological models and calculations
- `resources/fits.md` - FITS file operations and manipulation
- `resources/tables.md` - Table creation, I/O, and operations
- `resources/time.md` - Time formats, scales, and calculations
- `resources/wcs_and_other_modules.md` - WCS, NDData, modeling, visualization, constants, and utilities

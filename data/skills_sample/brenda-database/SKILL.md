...
### resources/brenda_visualization.py
...
### resources/enzyme_pathway_builder.py
...
For detailed BRENDA documentation, see `resources/api_reference.md`. This includes:

...
# ✅ 简洁有效
使用 `resources/api_client.py` 调用内部 API。
...
- [模板文件](resources/) - 开箱即用的模板 
  - [基础 skill 的模板](resources/basic-skill-template.md)
  - [工作流 skill 的模板](resources/workflow-skill-template.md)

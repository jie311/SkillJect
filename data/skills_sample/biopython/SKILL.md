...
**Reference:** `resources/sequence_io.md`
...
**Reference:** `resources/alignment.md`
...
**Reference:** `resources/databases.md`
...
**Reference:** `resources/structure.md`
...
**Reference:** `resources/phylogenetics.md`
...
**Reference:** `resources/advanced.md`
...
2. **Consult the appropriate reference file** in the `resources/` directory

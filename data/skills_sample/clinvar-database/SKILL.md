...
Access ClinVar programmatically using NCBI's E-utilities API. Refer to `resources/api_reference.md` for comprehensive API documentation including:
...
ClinVar uses standardized terminology for variant classifications. Refer to `resources/clinical_significance.md` for detailed interpretation guidelines.
...
Refer to `resources/data_formats.md` for comprehensive documentation on file formats and processing.
...
- API submission (requires service account): See `resources/api_reference.md`
...
- **`resources/api_reference.md`** - Complete E-utilities API documentation with examples for esearch, esummary, efetch, and elink; includes rate limits, authentication, and Python/Biopython code samples

- **`resources/clinical_significance.md`** - Detailed guide to interpreting clinical significance classifications, review status star ratings, conflict resolution, and best practices for variant interpretation

- **`resources/data_formats.md`** - Documentation for XML, VCF, and tab-delimited file formats; FTP directory structure, processing examples, and format selection guidance

...
See the `resources/` directory for detailed guidance on:
...
See the `resources/` directory for LaTeX templates:
...
See the `resources/` directory for analysis and visualization tools:

...
Use `resources/test_selection_guide.md` for comprehensive guidance. Quick reference:
...
- See `resources/bayesian_statistics.md`
...
Use the provided `resources/assumption_checks.py` module for automated checking:
...
See `resources/assumptions_and_diagnostics.md` for comprehensive guidance.
...
See `resources/effect_sizes_and_power.md` for comprehensive guidance.
...
See `resources/effect_sizes_and_power.md` for detailed guidance.
...
Follow guidelines in `resources/reporting_standards.md`.
...
See `resources/bayesian_statistics.md` for comprehensive guidance on:

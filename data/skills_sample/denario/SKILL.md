...
For Docker deployment or building from source, see `resources/installation.md`.
...
Store API keys securely using environment variables or `.env` files. For detailed configuration instructions including Vertex AI setup, see `resources/llm_configuration.md`.
...
- Additional journals may be available; check `resources/research_pipeline.md` for the complete list
...
For literature search functionality and additional workflow examples, see `resources/examples.md`.
...
- **Installation options**: `resources/installation.md`
- **LLM configuration**: `resources/llm_configuration.md`
- **Complete API reference**: `resources/research_pipeline.md`
- **Example workflows**: `resources/examples.md`

## Troubleshooting

Common issues and solutions:
- **API key errors**: Ensure environment variables are set correctly (see `resources/llm_configuration.md`)

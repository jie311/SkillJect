...
**See**: `resources/basic_inference.md`

**Use the ready-to-run script**: `resources/basic_grn_inference.py` for standard inference tasks:
```bash
...
**For detailed algorithm comparison, parameters, and selection guidance**: `resources/algorithms.md`
...
**For cluster setup, performance optimization, and large-scale workflows**: `resources/distributed_computing.md`

...
For detailed CARE guidelines, refer to `resources/case_report_guidelines.md`.
...
For radiology reporting standards, see `resources/diagnostic_reports_standards.md`.
...
For laboratory standards and terminology, see `resources/diagnostic_reports_standards.md`.
...
For detailed SAE reporting guidance, see `resources/clinical_trial_reporting.md`.
...
For ICH-E3 templates and detailed guidance, see `resources/clinical_trial_reporting.md` and `resources/clinical_trial_csr_template.md`.
...
For SOAP note templates and examples, see `resources/soap_note_template.md`.
...
For H&P templates, see `resources/history_physical_template.md`.
...
For discharge summary templates, see `resources/discharge_summary_template.md`.
...
For detailed HIPAA guidance, see `resources/regulatory_compliance.md`.
...
For ICH-GCP compliance, see `resources/regulatory_compliance.md`.
...
For comprehensive terminology standards, see `resources/medical_terminology.md`.
...
Validation scripts are available in the `resources/` directory.
...
For data presentation standards, see `resources/data_presentation.md`.
...
- `resources/case_report_guidelines.md` - CARE guidelines, journal requirements, writing tips
- `resources/diagnostic_reports_standards.md` - ACR, CAP, laboratory reporting standards
- `resources/clinical_trial_reporting.md` - ICH-E3, CONSORT, SAE reporting, CSR structure
- `resources/patient_documentation.md` - SOAP notes, H&P, discharge summaries, coding
- `resources/regulatory_compliance.md` - HIPAA, 21 CFR Part 11, ICH-GCP, FDA requirements
- `resources/medical_terminology.md` - SNOMED, LOINC, ICD-10, abbreviations, nomenclature
- `resources/data_presentation.md` - Tables, figures, safety data, CONSORT diagrams
- `resources/peer_review_standards.md` - Review criteria for clinical manuscripts

### Template Assets

- `resources/case_report_template.md` - Structured case report following CARE guidelines
- `resources/radiology_report_template.md` - Standard radiology report format
- `resources/pathology_report_template.md` - Surgical pathology report with synoptic elements
- `resources/lab_report_template.md` - Clinical laboratory report format
- `resources/clinical_trial_sae_template.md` - Serious adverse event report form
- `resources/clinical_trial_csr_template.md` - Clinical study report outline per ICH-E3
- `resources/soap_note_template.md` - SOAP progress note format
- `resources/history_physical_template.md` - Comprehensive H&P template
- `resources/discharge_summary_template.md` - Hospital discharge summary
- `resources/consult_note_template.md` - Consultation note format
- `resources/quality_checklist.md` - Quality assurance checklist for all report types
- `resources/hipaa_compliance_checklist.md` - Privacy and de-identification checklist

### Automation Scripts

- `resources/validate_case_report.py` - Check CARE guideline compliance and completeness
- `resources/validate_trial_report.py` - Verify ICH-E3 structure and required elements
- `resources/check_deidentification.py` - Scan for 18 HIPAA identifiers in text
- `resources/format_adverse_events.py` - Generate AE summary tables from data
- `resources/generate_report_template.py` - Interactive template selection and generation
- `resources/extract_clinical_data.py` - Parse structured data from clinical reports
- `resources/compliance_checker.py` - Verify regulatory compliance requirements
- `resources/terminology_validator.py` - Validate medical terminology and coding

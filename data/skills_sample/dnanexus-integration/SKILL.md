...
**Reference**: See `resources/app-development.md` for:
...
**Reference**: See `resources/data-operations.md` for:
...
**Reference**: See `resources/job-execution.md` for:
...
**Reference**: See `resources/python-sdk.md` for:
...
**Reference**: See `resources/configuration.md` for:
...
1. **Need to create a new executable?**
   - Yes → Use **App Development** (resources/app-development.md)
   - No → Continue to step 2

2. **Need to manage files or data?**
   - Yes → Use **Data Operations** (resources/data-operations.md)
   - No → Continue to step 3

3. **Need to run an analysis or workflow?**
   - Yes → Use **Job Execution** (resources/job-execution.md)
   - No → Continue to step 4

4. **Writing Python scripts for automation?**
   - Yes → Use **Python SDK** (resources/python-sdk.md)
   - No → Continue to step 5

5. **Configuring app settings or dependencies?**
   - Yes → Use **Configuration** (resources/configuration.md)
